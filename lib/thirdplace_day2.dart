...
class ThirdplaceDay2Main extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String? startTime = Provider.of<ThirdPlaceDay2>(context, listen: false)
        .startTime; // Variable to hold start time
    String? endTime = Provider.of<ThirdPlaceDay2>(context, listen: false)
        .endTime; // Variable to hold end time
    String? budget = Provider.of<ThirdPlaceDay2>(context, listen: false).budget;
    ...
    void _showTimePickerDialog() async {
      bool isStartTimePicker =
          Provider.of<ThirdPlaceDay2>(context, listen: false).isStartTimePicker;
