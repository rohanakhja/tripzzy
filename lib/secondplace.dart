...
class Secondplace extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String? startTime = Provider.of<SecondPlaceDetails>(context, listen: false)
        .startTime; // Variable to hold start time
    String? endTime = Provider.of<SecondPlaceDetails>(context, listen: false)
        .endTime; // Variable to hold end time
    String? budget =
        Provider.of<SecondPlaceDetails>(context, listen: false).budget;
