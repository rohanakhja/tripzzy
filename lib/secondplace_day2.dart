...
class SecondplaceDay2Main extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    String? enteredLocation =
        Provider.of<SecondPlaceDay2>(context, listen: false)
            .enteredLocation; // Variable to hold entered text
    String? startTime = Provider.of<SecondPlaceDay2>(context, listen: false)
        .startTime; // Variable to hold start time
    String? endTime = Provider.of<SecondPlaceDay2>(context, listen: false)
        .endTime; // Variable to hold end time
    String? budget =
        Provider.of<SecondPlaceDay2>(context, listen: false).budget;
