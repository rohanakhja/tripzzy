...
class ThirdplaceDay4Main extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    String? enteredLocation =
        Provider.of<ThirdPlaceDay4>(context, listen: false)
            .enteredLocation; // Variable to hold entered text
    String? startTime = Provider.of<ThirdPlaceDay4>(context, listen: false)
        .startTime; // Variable to hold start time
    String? endTime = Provider.of<ThirdPlaceDay4>(context, listen: false)
        .endTime; // Variable to hold end time
    String? budget = Provider.of<ThirdPlaceDay4>(context, listen: false).budget;
    ...
    void _showTimePickerDialog() async {
      bool isStartTimePicker =
          Provider.of<ThirdPlaceDay4>(context, listen: false).isStartTimePicker;
