...
class Thirdplace extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    String? enteredLocation =
        Provider.of<ThirdPlaceDetails>(context, listen: false)
            .enteredLocation; // Variable to hold entered text
    String? startTime = Provider.of<ThirdPlaceDetails>(context, listen: false)
        .startTime; // Variable to hold start time
    String? endTime = Provider.of<ThirdPlaceDetails>(context, listen: false)
        .endTime; // Variable to hold end time
    String? budget =
        Provider.of<ThirdPlaceDetails>(context, listen: false).budget;
              ...
              child: ClipRRect(
                ...
                child: ColorFiltered(
                  colorFilter: ColorFilter.mode(
                    Colors.grey.withOpacity(0.3), // Set opacity and color
                    BlendMode.srcATop,
                  ),
                  child: Image.asset(
