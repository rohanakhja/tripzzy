...
class FirstplaceDay2Main extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String? startTime = Provider.of<FirstPlaceDay2>(context, listen: false)
        .startTime; // Variable to hold start time
    String? endTime = Provider.of<FirstPlaceDay2>(context, listen: false)
        .endTime; // Variable to hold end time
    String? budget = Provider.of<FirstPlaceDay2>(context, listen: false).budget;
    ...
    void _showTimePickerDialog() async {
      bool isStartTimePicker =
          Provider.of<FirstPlaceDay2>(context, listen: false).isStartTimePicker;
